	...
	async function handleNewChat(event: CustomEvent | {detail : {retrieval : boolean}}) {
		...
		if (!event.detail.retrieval) {
			...
			try {
				...
				// 	messageContentList.push(messages[i]);
				// }
...
<div class="main-container bg-gray-200">
	<div class="mobile-header bg-gray-700 flex justify-between items-center p-3 md:hidden mb-0">
        <div class="flex items-center space-x-4">
            ...
            <span class="text-gray-300 font-semibold">IN-Q</span>
        </div>
        <div class="flex items-center space-x-4">
	...
	<div class="sidemenu bg-gray-700 h-full w-20 md:flex flex-col justify-between items-center p-5 hidden">
		<div class="flex flex-col items-center space-y-4">
			...
			<div class="icon-container flex flex-col items-center" data-info="Chat-History">
			...
			<div class="icon-container flex flex-col items-center" data-info="Open New Chat">
		...
		<div class="icon-container flex flex-col items-center" data-info="Logout">
