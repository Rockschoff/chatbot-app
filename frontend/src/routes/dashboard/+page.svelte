...
<div class="main-container bg-white">
	<div class="sidemenu bg-white  border-r-2 hover:border-r-4 transition-all duration-300 border-black h-full w-20 flex flex-col justify-between items-center p-5">
		<div class="flex flex-col items-center space-y-4">
			<svg id='profile' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-10 h-10 fill-gray-500 hover:fill-black" on:click={()=>{goto("/dashboard/profile")}}>
				<path d="M304 128a80 80 0 1 0 -160 0 80 80 0 1 0 160 0zM96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM49.3 464l349.5 0c-8.9-63.3-63.3-112-129-112l-91.4 0c-65.7 0-120.1 48.7-129 112zM0 482.3C0 383.8 79.8 304 178.3 304l91.4 0C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7L29.7 512C13.3 512 0 498.7 0 482.3z"/>
			</svg>
		  <svg id="chat-history" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-10 h-10 {show_sidebar?"fill-black":"fill-gray-500"} hover:fill-black" on:click={()=>{show_sidebar = !show_sidebar}}>
		  ...
		  <svg id="new-chat" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-10 h-10 fill-gray-500 hover:fill-black" on:click={()=>{handleNewChat({detail:{retrieval : false}})}}>
			<path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM232 344l0-64-64 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l64 0 0-64c0-13.3 10.7-24 24-24s24 10.7 24 24l0 64 64 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-64 0 0 64c0 13.3-10.7 24-24 24s-24-10.7-24-24z"/>
		  </svg>
		</div>
		<svg id="logout" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-10 h-10 fill-gray-500 hover:fill-black" on:click={logout}>
	...
	<div class="chat-window bg-white shadow-md w-full">
